...
async def total(bot, message):
    ...
    try:
        ...
        await msg.edit(f'📁 Files That I Saved files: {total}')
    except Exception as e:
...
async def bot_info(bot, message):
    ...
    await message.reply(text=f"{ABOUT ME}", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
